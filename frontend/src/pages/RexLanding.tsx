      ...
      <nav className="relative z-10 border-b border-white/10 bg-[#06111f]/75 backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-5 py-5 lg:px-8">
          ...
          <div className="flex items-center gap-3">
            <a href="https://github.com/fernandolukoki94-beep/luko-memoryos" target="_blank" rel="noreferrer" className="hidden text-sm text-slate-400 transition hover:text-white sm:block">Origin project</a>
